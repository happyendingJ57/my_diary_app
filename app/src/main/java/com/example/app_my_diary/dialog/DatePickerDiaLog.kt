...
class DatePickerDiaLog : BaseBottomSheetDialog<DialogDatePickerBinding>() {
    ...
    fun isValidDate(): Boolean {
        ...
        return (calendar!!.get(Calendar.YEAR) < todayCalendar.get(Calendar.YEAR) - minimumYear) || ((calendar!!.get(
            Calendar.YEAR
        ) == todayCalendar.get(Calendar.YEAR) - minimumYear) && (calendar!!.get(Calendar.DAY_OF_YEAR) <= todayCalendar.get(
