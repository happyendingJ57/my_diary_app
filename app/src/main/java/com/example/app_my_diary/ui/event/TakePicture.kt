...
import com.example.app_my_diary.databinding.LayoutTakePicktureBinding
import com.example.app_my_diary.utils.camerax.MainExecutor
...
class TakePicture : BaseViewModelDialogFragment<LayoutTakePicktureBinding>() {
    ...
    private fun takePicture() {
        ...
        localImageCapture.takePicture(outputOptions,
