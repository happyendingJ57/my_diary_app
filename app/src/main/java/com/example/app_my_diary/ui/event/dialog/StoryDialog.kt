package com.example.app_my_diary.ui.event.dialog
...
import com.example.app_my_diary.databinding.LayoutStoryDialogBinding
...
import com.example.app_my_diary.ui.event.dialog.adapter.PickingPhotoAdapter
import com.example.app_my_diary.ui.event.dialog.pickphoto.PickPhotoStoryDialog
...
class StoryDialog : BaseFullAlertDialog<LayoutStoryDialogBinding>(),
    ...
    fun showMessageDialogUpdateStory(description: String) {
        val message = "Bạn có muốn lưu câu chuyện này?. Nếu bạn loại bỏ ngay bây giờ, bạn sẽ mất câu chuyện này"
