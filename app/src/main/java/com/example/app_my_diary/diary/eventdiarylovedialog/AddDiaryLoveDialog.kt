package com.example.app_my_diary.diary.eventdiarylovedialog
...
import com.example.app_my_diary.adapter.PickingPhotoAdapter
import com.example.app_my_diary.base.BaseViewModelDialogFragment
import com.example.app_my_diary.databinding.LayoutDiaryLoveDialogBinding
import com.example.app_my_diary.dialog.MessageAlertDialog
import com.example.app_my_diary.dialog.PickPhotoStoryDialog
...
import com.example.app_my_diary.utils.Utils.deepEqualTo
import com.hola360.crushlovecalculator.ui.lovediary.eventdiarylovedialog.AddDiaryLoveDialogViewModel


class AddDiaryLoveDialog : BaseViewModelDialogFragment<LayoutDiaryLoveDialogBinding>(),
    PickingPhotoAdapter.OnPickPhotoItemClickListener,
    ...
    fun actionDone(description: String, title: String) {
        when (checkInformation(description, title)) {
            ...
            EMPTY_INFORMATION -> {
                Toast.makeText(requireContext(), "Empty Information", Toast.LENGTH_SHORT).show()
            }
    ...
    fun saveDiary(description: String, title: String) {
        if (diaryModel != null) {
            ...
            viewModel.addDiary(description, imageList, title, weatherIcon!!)
        }
    }
